...
/// <summary>
/// Este script define el comportamiento de un enemigo en un juego, incluyendo su capacidad de patrullar, detectar y 
/// perseguir al jugador, así como realizar ataques cuando está en modo de persecución.
/// </summary>
